...
export const packages: PackageTier[] = [
  {
    ...
    taglineEn: "Site build + on-page basics — you supply the photos",
    taglineZh: "适合：已有图片，要专业页面 · 基础收录",
    sections: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            labelZh: "即时在线报价计算器",
            included: false,
            detailEn: "Standard Launch tier or add-on",
            detailZh: "见标准上线包或加购",
          },
        ],
      },
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            included: false,
            detailEn: "Standard Launch — local SEO starter",
            detailZh: "见标准上线包「本地 SEO 起步」",
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          { labelEn: "Sydney on-site shoot", labelZh: "悉尼上门实拍", included: false },
          {
            ...
            included: false,
            detailEn: "Visual Launch / Flagship",
            detailZh: "见实拍标准包或旗舰包",
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            labelZh: "摄影底片 + 精修全赠",
            included: false,
            detailEn: "Visual Launch / Flagship tiers include full pack",
            detailZh: "实拍标准包 / 旗舰包含底片与全部精修",
          },
          {
  ...
  },
  {
    ...
    nameZh: "标准上线",
    price: 1280,
    deliveryEn: "Preview in 3 business days once brief and your images are ready",
    deliveryZh: "资料与您提供的图片齐全后 3 个工作日内出预览",
    taglineEn: "Essential + indexing tools + local SEO starter — you supply photos",
    taglineZh: "建站 + 本地 SEO — 您提供图片，无上门拍摄",
    sections: [
      {
        titleEn: "Everything in Essential Refresh",
        titleZh: "包含「基础焕新」全部打勾项",
        rollup: true,
        items: [
          {
            labelEn: "All ✓ items from Essential (on-page SEO basics)",
            labelZh: "含基础焕新全部打勾项（页面收录基础）",
            included: true,
          },
        ],
      },
      {
        titleEn: "Indexing & On-page tech",
        titleZh: "收录与页面技术）",
        items: [
          {
            labelEn: "Google Search Console: verify + submit sitemap",
      ...
      },
      {
        ...
        titleZh: "摄影与视觉",
        items: [
          { labelEn: "Optimise your supplied images for web", labelZh: "使用并优化您提供的图片", included: true },
          { labelEn: "Sydney on-site shoot", labelZh: "悉尼上门实拍", included: false, detailEn: "Visual Launch tier", detailZh: "见实拍标准包" },
          {
      ...
      },
      {
        ...
        items: [
          {
            labelEn: "Alt text on your images used on the site",
            labelZh: "网站所用图片补充 Alt 说明",
            included: true,
          },
          {
          ...
          {
            labelEn: "Upload up to 12 of your photos to GBP",
            labelZh: "上传您提供的图片至 GBP（最多 12 张）",
            included: true,
          },
          {
  ...
  {
    id: "visual",
    nameEn: "Visual Launch",
    nameZh: "视觉旗舰包",
    price: 1580,
    deliveryEn: "Preview in 3 business days once brief and shoot assets are ready",
    deliveryZh: "资料与拍摄素材齐全后 3 个工作日内出预览",
    highlight: true,
    taglineEn: "Standard Launch + curated on-site shoot",
    taglineZh: "主力推荐：建站 + 实拍 + 本地 SEO",
    sections: [
      {
        titleEn: "Everything in Standard Launch",
        titleZh: "包含「标准上线」全部打勾项",
        rollup: true,
        items: [
          {
            labelEn: "All ✓ items from Standard (local SEO starter, conversion)",
            labelZh: "含标准上线全部：本地 SEO 起步、转化模块等",
            included: true,
          },
        ],
      },
      ...
      {
        titleEn: "Local SEO — shoot assets",
        titleZh: "本地 SEO（实拍素材）",
        items: [
          {
          ...
          },
          {
            ...
            included: true,
            detailEn: "Replaces client-supplied GBP uploads from Standard",
            detailZh: "以实拍替换标准包「客户供图上传」",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    taglineEn: "Premium visual + deeper local search & maps pass",
    taglineZh: "高级感视觉 + 进阶本地 SEO 复查（不含广告代投）",
    sections: [
      {
        titleEn: "Everything in Visual Launch",
        titleZh: "包含「视觉旗舰」全部打勾项",
        rollup: true,
        items: [
          {
            labelEn: "All ✓ items from Visual Launch (shoot, local SEO, conversion)",
            labelZh: "含视觉旗舰全部：实拍、本地 SEO、转化模块等",
            included: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            detailZh: "更多服务过程、团队与细节镜头 · 底片与社媒商用规则同实拍标准包",
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            included: true,
            detailEn: "Visual Launch includes up to 12",
            detailZh: "实拍标准包已含最多 12 张",
          },
          {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        noteZh: "主要页面切换 + 分语言 Meta · 仅基础/标准上线包（旗舰已含）",
      },
      {
      ...
      },
      {
        ...
        noteZh: "站内评价轮播 · 文案经您确认，仅基础/标准上线包（旗舰已含）",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        noteZh: "多账号、更多栏目、可加页 · 按范围报价 · 各档套餐均不含",
      },
    ],
  },
];
